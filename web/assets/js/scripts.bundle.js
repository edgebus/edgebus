...
// Comment due called from Dart App
...
var KTOffcanvas = function(elementId, options) {
    ...
    if (!element) {
        // return;
        throw new Error(`Wrong argument elementId '${elementId}' passed into KTOffcanvas. No such element.`);
    }
...
function KTOffcanvasFactory(panelId, baseClassName, closeByButtonId, toggleByButtonId) {
	if(typeof baseClassName !== "string") { throw new Error("Wrong argument 'baseClassName'. Expected type of string"); }
	if(typeof closeByButtonId !== "string") { throw new Error("Wrong argument 'closeByButtonId'. Expected type of string"); }
	if(typeof toggleByButtonId !== "string") { throw new Error("Wrong argument 'toggleByButtonId'. Expected type of string"); }

	var panel = KTUtil.get(panelId);
	var opts = {
		overlay: true,
		baseClass: baseClassName, // 'kt-quick-panel'
		closeBy: closeByButtonId, // 'kt_quick_panel_close_btn'
		toggleBy: toggleByButtonId, // 'kt_quick_panel_toggler_btn'
	};

	var ktOffcanvasInstance = new KTOffcanvas(panel, opts);

	return ktOffcanvasInstance;
}
...
//     KTDemoPanel.init();
// });
function KTDemoPanel_init() {
	// alert("KTDemoPanel_init()");
	KTDemoPanel.init();
}
...
// });
function KTOffcanvasPanel_init(){
	// alert("KTOffcanvasPanel_init()");
	KTOffcanvasPanel.init();
}
...
//     KTQuickPanel.init();
// });
function KTQuickPanel_init() {
	// alert("KTQuickPanel_init()");
	KTQuickPanel.init();
}
