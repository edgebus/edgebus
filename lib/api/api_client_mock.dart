...
import 'package:edgebus_console/model/ingress_path.dart';
import 'package:edgebus_console/model/ingress_url.dart';
...
class ApiClientMock extends ApiClient {
  ...
  ApiClientMock()
    ...
    final IngressPath ingress1 = IngressPath(
      index1,
      "HTTP_HOST",
      "/webhooks/fireblocks",
    ...
    final IngressUrl ingress2 = IngressUrl(
      index2,
      "WEB_SOCKET_CLIENT",
      "TOPC44e5b80b06f1447ebf38b6ab2c84c84a",
    ...
    final IngressPath ingress3 = IngressPath(
      index3,
      "HTTP_HOST",
      "/webhooks/fireblocks",
      "TOPC44e5b80b06f1447ebf38b6ab2c84c84a",
    ...
    this._ingressesPath[index1] = ingress1;
    this._ingressesUrl[index2] = ingress2;
    this._ingressesPath[index3] = ingress3;
  }
...
// Sure what description change
  ...
  Future<(List<IngressPath>, List<IngressUrl>)> listIngress(
    ...
    await Future.delayed(const Duration(seconds: 1));
    final List<IngressPath> ingressPath =
        this._ingressesPath.values.toList(growable: false);
    final List<IngressUrl> ingressUrl =
        this._ingressesUrl.values.toList(growable: false);

    return (ingressPath, ingressUrl);
  }
}
